...
public class Trip {
    ...
    public Trip(int trip_id, String date, String time, String name, String description, int av_temperature, int av_pressure, String latitudes, String longitudes, String photo_ids) {
